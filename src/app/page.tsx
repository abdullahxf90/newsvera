          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section>
              <div className="flex items-center justify-between mb-5">
                ...
                <Link href="/category/business" className="text-sm text-primary-900 dark:text-accent-400 hover:underline font-medium">
                  More →
                </Link>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {editorsPicks.map((article) => (
              <Link key={article.id} href={`/article/${article.slug}`} className="group">
                <div className="aspect-video relative overflow-hidden rounded-lg mb-3 image-zoom">
                  <Image src={article.featuredImage} alt={article.title} fill className="object-cover" sizes="(max-width:768px) 100vw, 25vw" />
                </div>
